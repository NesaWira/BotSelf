...
cl = LINETCR.LINE()
cl.login(token="En9BTO2IGw8pF3yyEeKc.bXcKkNxGPhATAhy524WgNa.Lho2Q3mH2kf58/i07l8DMyzrRft7mitMor/UPuDyuio=")
#cl.login(token='')
cl.loginResult()
print "===[Login Success]==="
...
#--------------NOTIFIED_INVITE_INTO_GROUP----------------
	    ...
	    if mid in op.param3:
			...
			cl.cancelGroupInvitation(op.param1, [op.param3])
			cl.sendText(op.param1, "kicker jgn di invite oc")
		    else:
			pass
...
#--------------------------NOTIFIED_UPDATE_GROUP---------------------
		...
		if op.param2 in admin:
		    pass
                    ...
                    cl.sendText(msg.to, "Jangan mainan QR Bajingan")
            else:
                pass
#--------------------------SEND_MESSAGE---------------------------
        if op.type == 25:
...
#--------------------------------------------------------
		...
		gCreator = ginfo.creator.mid
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu Yang Buat Grup Ini✖‿✖ ")
#--------------------------------------------------------
...
#--------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        cl.sendText(msg.to,"✖‿✖No one is inviting✖‿✖")
                else:
                    Cl.sendText(msg.to,"Can not be used outside the group")
#--------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    cl.updateGroup(X)
                    cl.sendText(msg.to,"✖‿✖Url Active✖‿✖")
                else:
                    cl.sendText(msg.to,"Can not be used outside the group")
#--------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    cl.updateGroup(X)
                    cl.sendText(msg.to,"✖‿✖Url inActive✖‿✖")
...
#--------------------------------------------------------
                ...
                wait["AutoJoin"] = False
                cl.sendText(msg.to,"✖‿✖AutoJoin inActive✖‿✖")

#--------------------------------------------------------
	    elif msg.text in ["Autocancel:on"]:
                wait["AutoCancel"] = True
                cl.sendText(msg.to,"✖‿✖The group of people and below decided to automatically refuse invitation✖‿✖")
...
#--------------------------CEK SIDER------------------------------
                ...
                cl.sendText(msg.to, "✖‿✖Checkpoint checked✖‿✖")
                print "@setview"
...
#--------------------------------------------------------
		...
		cl.sendText(msg.to,"✖‿✖Zeeb Success BC Nesa✖‿✖")
#--------------------------------------------------------
...
#--------------------------------------------------------
                ...
                cl.sendText(msg.to,"send contact✖‿✖")
...
#--------------------------------------------------------
		...
		try:
		    ...
		    cl.sendText(msg.to, "Success backup profile✖‿✖")
		except Exception as e:
		    cl.sendText(msg.to, str(e))
#--------------------------------------------------------
...
#--------------------------------------------------------
			    ...
			    if target not in admin:
                                try:
                                    ...
                                    cl.sendText(msg.to,"Succes Nesa")
                                except:
...
#--------------------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Blacklist emang pantas tuk di usir ✖‿✖")
#--------------------------------------------------------
